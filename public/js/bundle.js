    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Account created successfuly');
            window.setTimeout(function () {
              location.assign('/', 0);
            });
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _stripeJs.loadStripe)('pk_test_51NUCfvIH6jXPMpb7bKELKOrhaH0yMABwHqJk5Uqeo40CHhJ39Brg0Dod88PHUM7cAZGk8JIRbO8vbGMAISjZ0TuN00Yctx6EGk');
        case 3:
