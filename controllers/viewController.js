...
exports.getLoginForm = (req, res) => {
  res
    ...
    .set(
      'Content-Security-Policy',
      "default-src 'self' https://cdnjs.cloudflare.com/ajax/libs/axios/1.4.0/axios.min.js ;base-uri 'self';block-all-mixed-content;font-src 'self' https: data:;frame-ancestors 'self';img-src 'self' data:;object-src 'none';script-src https://cdnjs.cloudflare.com https://api.mapbox.com https://js.stripe.com/v3/ 'self' blob: ;script-src-attr 'none';style-src 'self' https: 'unsafe-inline';upgrade-insecure-requests;"
    )
    .render('login', {
